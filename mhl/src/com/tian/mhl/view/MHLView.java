package com.tian.mhl.view;

import com.tian.mhl.domain.*;
import com.tian.mhl.service.BillService;
import com.tian.mhl.service.DiningTableService;
import com.tian.mhl.service.EmployeeService;
import com.tian.mhl.service.MenuService;
import com.tian.mhl.utils.Utility;
...
//        System.out.println("=======显示完毕======");
    ...
    public void orderDiningTable() {
        ...
        if (key == 'Y') {
            ...
            //判断餐桌状态是否为空
            if (!("空".equals(diningTable.getState()))) {//不为空
    ...
    public void payBill() {
        ...
        System.out.println("结账方法（现金/支付宝/微信）回车表示退出：");
